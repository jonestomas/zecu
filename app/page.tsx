...
const _translations = {
  ...
  en: {
    ...
    hero: {
      ...
      subtitle:
        'Is it a scam or a safe message? What should I do? Get answers in seconds with Zecubot.',
  ...
  const _handleLogout = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.warn('Error al cerrar sesión. Por favor, intenta de nuevo.');
      }
    } catch (error) {
          ...
          <div className='container mx-auto max-w-6xl'>
            <div className='grid md:grid-cols-3 gap-8'>
              ...
              <div className='glass-card glass-card-hover rounded-2xl p-8 text-center'>
                ...
                <h3 className='text-xl font-semibold text-foreground mb-4'>
                  {t.benefits.confidential.title}
                </h3>
                <p className='text-muted-foreground leading-relaxed'>
                  {t.benefits.confidential.description}
                </p>
              </div>
              ...
              <div className='glass-card glass-card-hover rounded-2xl p-8 text-center'>
                ...
                <h3 className='text-xl font-semibold text-foreground mb-4'>
                  {t.benefits.action.title}
                </h3>
                <p className='text-muted-foreground leading-relaxed'>
                  {t.benefits.action.description}
                </p>
              </div>
            </div>
          </div>
