...
import { Poppins, Inter, JetBrains_Mono, Geist as V0_Font_Geist, Geist_Mono as V0_Font_Geist_Mono, Source_Serif_4 as V0_Font_Source_Serif_4 } from 'next/font/google'
...
export default function RootLayout({
  ...
  return (
    <html lang="es" className={`${poppins.variable} ${inter.variable} ${jetbrainsMono.variable}`}>
      <body className={`font-sans antialiased ${fontVariables} ${_v0_fontVariables}`}>{children}</body>
    </html>
  )
}
