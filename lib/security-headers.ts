...
export function withSecurityHeaders(handler: (_request: NextRequest) => Promise<NextResponse>) {
...
export function validateOrigin(_request: NextRequest): boolean {
...
export function detectSuspiciousActivity(_request: NextRequest): boolean {
...
// Log de seguridad
export function logSecurityEvent(event: string, _request: NextRequest, details?: any) {
  const clientIP =
